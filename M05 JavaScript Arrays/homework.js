...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   let sumNums = arrayOfNums.reduce((a, b) => a + b, 0);
   return sumNums;
}
...
function mesesDelAño(array) {
   ...
   for (let i = 0; i < array.length; i++) {
      ...
      newArray.push(array[i]) && mesesFiltrados++ : false;
   }
   return mesesFiltrados !== 3 ? "No se encontraron los meses pedidos" : newArray;
